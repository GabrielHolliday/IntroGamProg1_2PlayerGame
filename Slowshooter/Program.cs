...
+---+   +---+";
        ...
        static void PromptPlr()
        {
            int ihatethisFunction;
            while(true)
            {
                Console.SetCursorPosition(19, 19);
                Console.WriteLine("Pick Max score: ");
                string num = Console.ReadLine();
                if (int.TryParse(num, out ihatethisFunction))
                {
                    
                    maxScore =  int.Parse(num).Clamp(1, int.MaxValue);
                    break;
                }
                Console.Clear();
                Console.SetCursorPosition(19, 19);
        ...
        {
            if(forceLoose.Item1 == true)
            {
                if(forceLoose.Item2 == true)
                {
                    p2Score++;
            ...
            if(ballPos.Item2 == p1_min_max_y.Item2 + 1 | ballPos.Item2 == p1_min_max_y.Item1 - 1)
            {
                isUp = !isUp;
            }
           
            if(ballPos.Item1 == p1_min_max_x.Item1 + 1 | ballPos.Item1 == p2_min_max_x.Item1 - 1)
            {
                if(isLeft == true)
                {
                    if (ballPos.Item2 != p1_y_pos & ballPos.Item2 != p1_y_pos + 1 & ballPos.Item2 != p1_y_pos - 1)
                    {
                        forceLoose = (true, true);
                    }
                }
                else
                {
                    if (ballPos.Item2 != p2_y_pos & ballPos.Item2 != p2_y_pos + 1 & ballPos.Item2 != p2_y_pos - 1)
                    {
                        forceLoose = (true, false);
                    }
                }
        ...
        static (bool , bool) forceLoose = (false, false);
        ...
        static void DrawBenj()
        {
            ...
            Console.WriteLine($"\nWS for Player 1 -- P1 Score: {p1Score}");
            
            Console.WriteLine($"\nUp/Down for Player 2 -- P2 Score: {p2Score}");
            Console.ForegroundColor = ConsoleColor.White;
        }
        //
    }
